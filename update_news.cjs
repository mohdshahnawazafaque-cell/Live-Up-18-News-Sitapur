...
if (data.newsArticles && Array.isArray(data.newsArticles)) {
  data.newsArticles = data.newsArticles.filter(a => !a.headline.includes("इश्तियाक खान"));
} else if (Array.isArray(data)) {
  data = data.filter(a => !a.headline.includes("इश्तियाक खान"));
}
...
console.log("Professional news article updated successfully!");
