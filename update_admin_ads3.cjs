...
const marker = /<\/div>\s*\{\/\* Main Content - News Manager \*\/\}\s*<div className="lg:col-span-2">/;
...
content = content.replace(marker, newAdBlock);
fs.writeFileSync('src/pages/Admin.tsx', content);
console.log("Updated Admin with Ads using exact comment match");
